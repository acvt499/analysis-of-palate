%% ------------ Creating Matrix 3D for data set 2 (palate) ------------- %%
%% --------------------------------------------------------------------- %%
close all
clear, clc
%% ----------------------- Data set: Brooks 2 -------------------------- %%
...
loc_0="'C:\Users\User\Desktop\3rd Year Project\Brooks 2\Brooks2\S0000001\I0000010";
% loc_1 is the localisation of the dicom file 10-99 in the computer %
loc_1="'C:\Users\User\Desktop\3rd Year Project\Brooks 2\Brooks2\S0000001\I00000";
% loc_2 is the localisation of the dicom file 100-451 in the computer %
loc_2="'C:\Users\User\Desktop\3rd Year Project\Brooks 2\Brooks2\S0000001\\I0000";
...
Matrix_3D_2=zeros(x_1,y_1,numslices_1);
%% ------------------------ Creating 3D matrix ------------------------- %%
...
for slice_number=50:99
    ...
    Matrix_3D_2(:,:,numslices_1+1-slice_number)=B_1; 
end
for slice_number=100:numslices_1
    B_2=dicomread(strcat(loc_2,num2str(slice_number)));
    Matrix_3D_2(:,:,numslices_1+1-slice_number)=B_2;
end
%% ----------- Save matrix 3D for data set 2 for further use ----------- %%