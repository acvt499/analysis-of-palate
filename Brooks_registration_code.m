...
loc_2="C:\Users\User\Desktop\3rd Year Project\New data base\Brooks\Brooks_2_Matrix_3D.mat";
load(loc_2)
...
% teeth which are alwasy in the "upper half" of the matrix
...
if y_new_centre<(y_2)/2
    ...
    y_added_step_2=2*y_new_centre-y_2;
    Set_2_new_centre_step2=...
    zeros(x_2+x_added_step_1, y_2+y_added_step_2, z_2);
    Set_2_new_centre_step2(:,1:end-y_added_step_2-1,:)=...
    Set_2_new_centre_step1(:,:,:);
end
...
if y_new_centre<(y_2)/2
    ...
    Set_1_new_centre_step2=...
    zeros(x_2+x_added_step_1, y_2+y_added_step_2, z_2);
    Set_1_new_centre_step2(:,1:end-y_added_step_2-1,:)=...
    Set_1_new_centre_step1(:,:,:);
end 
% ----------------------------- Testing -------------------------------- %
